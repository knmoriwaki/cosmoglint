...
do
    ...
    do
        ...
        input_fname=${base_dir}/TNG300-1/TNG300-1_${snapshot_number}.h5

        output_catalog_fname=$output_dir/group.data_cube.${snapshot_number}.TNG300-1_test${global_param_id}.threshold${threshold}.${model_name}.seed${seed}.h5
