...
do
    ...
    do
        ...
        do
            ...
            python3 train_transformer.py --gpu_id $gpu_id --config_file $config_file --output_dir $output_dir --batch_size $batch_size --num_epochs $num_epochs --dropout 0 --sampler_weight_min $sampler_weight_min --save_freq 10 --no-show_pbar
