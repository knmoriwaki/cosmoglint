...
for snapshot_number in 13 15 17 19 21 23 25 29 33 35 40 43 49 55 67 99
do
    ...
    do
        ...
        do
            ...
            python3 train_transformer.py --gpu_id $gpu_id --output_dir $output_dir --data_path $data_path --max_length 50 --norm_param_file $norm_param_file --num_epochs $num_epochs --batch_size $batch_size --model_name $model_name --num_features_out $num_features_out --dropout 0 --sampler_weight_min $sampler_weight_min --save_freq 10
        done
    done
done