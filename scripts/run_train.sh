...
batch_size=128
for sampler_weight_min in 0.02 
do
    ...
    do
        ...
        python3 train.py --gpu_id $gpu_id --config_file $config_file --output_dir $output_dir --batch_size $batch_size --num_epochs $num_epochs --dropout 0 --sampler_weight_min $sampler_weight_min --save_freq 10 --exclude_ratio 0.5 --no-show_pbar
    done
done
