...
#python3 create_data_cube.py $args --input_fname $input_fname --output_fname $output_fname --model_dir $model_dir --NN_model_dir ./Transformer/NN/output --redshift_space
...
#python3 create_data_cube.py $args --input_fname $input_fname --output_fname $output_fname --model_dir $model_dir --NN_model_dir ./Transformer/NN/output 
