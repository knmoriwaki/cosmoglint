...
do
    ...
    python3 create_data_cube.py $_args --input_fname $input_fname --output_fname $output_dir/pinocchio.run${irun}.${model_name}.h5 --model_dir $model_dir 
    python3 create_data_cube.py $_args --input_fname $input_fname --output_fname $output_dir/pinocchio.run${irun}.${model_name}.mass_corrected.h5 --model_dir $model_dir --mass_correction_factor 0.8 

    #python3 create_data_cube.py $_args_catalog --input_fname $input_fname --output_fname $output_dir/pinocchio.run${irun}.${model_name}.mass_corrected.h5 --model_dir $model_dir --mass_correction_factor 0.8 
